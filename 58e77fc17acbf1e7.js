...
${t}`),
  ...
  (e, t, n) => {
    ...
    function tI(e, t, n) {
      ...
      try {
        ...
        if (
          ((tF = !1),
          (null !== tL || null !== tM) &&
            (u8(), tL && ((t = tL), (e = tM), (tM = tL = null), tD(t), e)))
        )
      ...
      switch (n) {
        ...
        case "formAction":
          ...
          if (
            ("function" == typeof a &&
              ("formAction" === n
                ? ("input" !== t && s6(e, t, "name", l.name, l, null),
                  s6(e, t, "formEncType", l.formEncType, l, null),
    ...
    function s7(e, t, n) {
      ...
      for (i in n)
        n.hasOwnProperty(i) && null != (l = n[i]) && s6(e, t, i, l, n, null);
    }
    function ce(e) {
      switch (e) {
        case "css":
    ...
    var fY = o.version;
    if ("19.3.0-canary-2bcbf254-20251020" !== fY)
      throw Error(u(527, fY, "19.3.0-canary-2bcbf254-20251020"));
    if (
