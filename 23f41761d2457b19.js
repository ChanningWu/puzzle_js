(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    t.s([
      ...
      ({ handleClick: t }) => {
        ...
        return (0, e.jsx)("div", {
          onClick: () => {
            (t(), n.push("/c81e728d9d4c2f636f067f89cc14862c"));
          },
          children: "Enter Level 2",
        });
      },
    ]);
  },
  ...
  (t) => {
    ...
    let T = (t) => (e) => "string" == typeof e && e.startsWith(t),
      w = T("--"),
      b = T("var(--"),
      P = (t) => !!b(t) && S.test(t.split("/*")[0].trim()),
      S =
        /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
    function A({ top: t, left: e, right: i, bottom: n }) {
    ...
    function F(t, e, i, n, s = 0.5) {
      let r = M(t.min, t.max, s);
      R(t, e, i, r, n);
    }
    function B(t, e) {
    ...
    let I = new Set([
      ...
      _ = (t) => (e) => e.test(t),
      Z = [N, H, X, Y, q, K, { test: (t) => "auto" === t, parse: (t) => t }],
      J = (t) => Z.find(_(t));
    t.i(47167);
    let Q = () => {},
      tt = () => {},
    ...
    let tw = (t) => Math.round(1e5 * t) / 1e5,
      ...
      tk = {
        test: (t) => tE.test(t) || tV.test(t) || tC.test(t),
        parse: (t) =>
          tE.test(t) ? tE.parse(t) : tC.test(t) ? tC.parse(t) : tV.parse(t),
        transform: (t) =>
          "string" == typeof t
            ? t
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              tk.test(t)
                ? (n.color.push(r), s.push(tL), i.push(tk.parse(t)))
                : t.startsWith("var(")
                  ? (n.var.push(r), s.push("var"), i.push(t))
                  : (n.number.push(r), s.push(tR), i.push(parseFloat(t))),
              ++r,
              "${}"
            ),
          )
      ...
      tU = {
        test: function (t) {
          return (
            isNaN(t) &&
            "string" == typeof t &&
            (t.match(tb)?.length || 0) + (t.match(tD)?.length || 0) > 0
          );
        },
        parse: tB,
      ...
      resolveNoneKeyframes() {
        ...
        i.length &&
          (function (t, e, i) {
            ...
            if (n && i) for (let s of e) t[s] = tq(i, n);
          })(t, i, e);
      }
      measureInitialState() {
      ...
      update(t, e) {
        ...
        ((this.prevMotionValues = (function (t, e, i) {
          for (let n in e) {
            ...
            else if (tZ(r)) t.addValue(n, t3(s, { owner: t }));
            else if (r !== s)
              if (t.hasValue(n)) {
                let e = t.getValue(n);
                ...
                t.addValue(n, t3(void 0 !== e ? e : s, { owner: t }));
              }
          }
      ...
      readValue(t, e) {
        ...
        if (null != i) {
          ...
          if (
            ...
            let n;
            ((n = i), !t9.find(_(n)) && tU.test(e) && (i = tq(t, e)));
          }
    ...
    function eb(t, { style: e, vars: i }, n, s) {
      let r,
        o = t.style;
      for (r in e) o[r] = e[r];
    ...
    class ej extends ey {
      ...
      readValueFromInstance(t, e) {
        ...
        return ((e = eD.has(e) ? e : eE(e)), t.getAttribute(e));
      }
      scrapeMotionValuesFromProps(t, e, i) {
        return eL(t, e, i);
      }
      ...
      renderInstance(t, e, i, n) {
        for (let i in (eb(t, e, void 0, n), e.attrs))
          t.setAttribute(eD.has(i) ? i : eE(i), e.attrs[i]);
      }
      mount(t) {
    ...
    let eO = (0, a.createContext)({}),
      eI = (0, a.createContext)({ strict: !1 }),
      eU = (0, a.createContext)({
        transformPagePoint: (t) => t,
        isStatic: !1,
        reducedMotion: "never",
      }),
      eN = (0, a.createContext)({});
    function e$(t) {
    ...
    let e_ = (t) => (e, i) => {
        ...
        return i
          ? o()
          : (null === (n = (0, a.useRef)(null)).current && (n.current = o()),
            n.current);
      },
      eZ = e_({ scrapeMotionValuesFromProps: eA, createRenderState: eW }),
      eJ = e_({ scrapeMotionValuesFromProps: eL, createRenderState: eY }),
    ...
    let e1 = "data-" + eE("framerAppearId"),
      e2 = (0, a.createContext)({}),
      e5 = en ? a.useLayoutEffect : a.useEffect;
    function e3(t, { forwardMotionProps: e = !1 } = {}, i, n) {
      ...
      function o(i, o) {
        ...
        if (!d && en) {
          ...
          ((h = e.MeasureLayout),
            (c.visualElement = (function (t, e, i, n, s) {
              let { visualElement: r } = (0, a.useContext)(eN),
                o = (0, a.useContext)(eI),
                l = (0, a.useContext)(eq),
                h = (0, a.useContext)(eU).reducedMotion,
                u = (0, a.useRef)(null);
              ((n = n || o.renderer),
                !u.current &&
                  n &&
        ...
        return (0, r.jsxs)(eN.Provider, {
          value: c,
          children: [
            h && c.visualElement
              ? (0, r.jsx)(h, { visualElement: c.visualElement, ...u })
              : null,
            (function (t, e, i, { latestValues: n }, s, r = !1) {
              let o = (
                  eB(t)
                    ? function (t, e, i, n) {
                        let s = (0, a.useMemo)(() => {
    ...
    function iD(t = 0.3, e = 0.3) {
      let i,
          ...
          if (!ik(t, iC) && ik(t, iV))
            if (t.visualDuration) {
              let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                n = i * i,
                s = 2 * U(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(n);
                ...
                ((o = U(0.05, 1, o)),
                  ...
                  o < 1
                    ? ((s = (e) => {
                        let n = e * o,
                          s = n * t;
                        return 0.001 - ((n - i) / iE(e, o)) * Math.exp(-s);
                      }),
                      (r = (e) => {
                        let n = e * o * t,
        ...
        v = Math.sqrt(h / d) / 1e3,
        x = 5 > Math.abs(y);
      if ((s || (s = x ? iP : iS), r || (r = x ? iA : iM), g < 1)) {
        let t = iE(v, g);
        i = (e) =>
          a -
          Math.exp(-g * v * e) *
      ...
      let T = {
        ...
        toString: () => {
          let t = Math.min(iw(T), 2e4),
            e = iT((e) => T.next(t * e).value, t, 30);
          return t + "ms " + e;
        },
        toTransition: () => {},
      };
    ...
    function iZ({
      ...
      var s;
      let r,
        o = Array.isArray(n) && "number" != typeof n[0] ? n.map(iG) : iG(n),
        a = { done: !1, value: e[0] },
        l = (function (t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
          ...
          let a = (function (t, e, i) {
              ...
              for (let i = 0; i < r; i++) {
                let r = s(t[i], t[i + 1]);
                (e && (r = ie(Array.isArray(e) ? e[i] || to : e, r)),
                  n.push(r));
              }
              return n;
            })(e, n, s),
          ...
          e,
          {
            ease: Array.isArray(o)
              ? o
              : e.map(() => o || iO).splice(0, e.length - 1),
          },
        );
      return {
    ...
    let i0 = { decay: iR, inertia: iR, tween: iZ, keyframes: iZ, spring: iD };
    function i1(t) {
    ...
    class i3 extends i2 {
      ...
      initAnimation() {
        ...
        a !== iZ &&
          "number" != typeof o[0] &&
          ((this.mixKeyframes = ie(i5, iv(o[0], o[1]))), (o = [0, 100]));
        ...
        ("mirror" === s &&
          ...
          null === l.calculatedDuration && (l.calculatedDuration = iw(l)));
      ...
      tick(t, e = !1) {
        ...
        return (
          b && p !== iR && (T.value = iQ(h, this.options, f, this.speed)),
          m && m(T.value),
          b && this.finish(),
          T
        );
    ...
    class ni extends i2 {
      ...
      set time(t) {
        ((this.finishedTime = null), (this.animation.currentTime = ii(t)));
      }
      get speed() {
    ...
    let nn = { anticipate: iz, backInOut: iW, circInOut: iH };
    class ns extends ni {
      constructor(t) {
        (!(function (t) {
    ...
    class nl extends i2 {
      ...
      onKeyframesResolved(t, e, i, n) {
        ...
        ((this.resolvedAt = tQ.now()),
          !(function (t, e, i, n) {
            ...
            ((ta.instantAnimations || !a) && h?.(iQ(t, i, e)),
            (t[0] = t[t.length - 1]),
            e7(i),
            (i.repeat = 0)));
        let u = {
          ...
          d =
            ...
            (function (t) {
              ...
              ? new ns({ ...u, element: u.motionValue.owner.current })
              : new i3(u);
      ...
      get animation() {
        return (
          this._animation ||
            (this.keyframeResolver?.resume(), (ty = !0), tx(), tv(), (ty = !1)),
          this._animation
        );
      }
      get duration() {
    ...
    let nh = (t) => null !== t,
      nu = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
      ...
      np =
        ...
        (o) => {
          ...
          return a.isSync ? new i3(d) : new nl(d);
        };
              ...
              o &&
                (function (t, e) {
                  ...
                  for (let e in (s = { ...s, ...i })) {
                    ...
                    t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, t3(i));
                  }
                })(t, o);
            });
          }),
    ...
    function nC(t, e, i, n) {
      return nM(t, e, (t) => nE(t) && i(t, nV(t)), n);
    }
    function nk(t) {
      return t.max - t.min;
    }
    function nD(t, e, i, n = 0.5) {
      ((t.origin = n),
    ...
    function nL(t, e, i) {
      ((t.min = i.min + e.min), (t.max = t.min + nk(e)));
    }
    function nj(t, e, i) {
      ((t.min = e.min - i.min), (t.max = t.min + nk(e)));
    }
    function nF(t, e, i) {
    ...
    class nU {
      constructor(
          ...
          (this.updatePoint = () => {
            ...
            let i = nW(this.lastMoveEventInfo, this.history),
              ...
              s =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(nI(t.x, e.x) ** 2 + nI(t.y, e.y) ** 2) >=
        ...
        const o = nN(nV(t), this.transformPagePoint),
          { point: a } = o,
          { timestamp: l } = tc;
        ...
        (h && h(t, nW(o, this.history)),
          (this.removeListeners = ie(
            nC(this.contextWindow, "pointermove", this.handlePointerMove),
            nC(this.contextWindow, "pointerup", this.handlePointerUp),
            nC(this.contextWindow, "pointercancel", this.handlePointerUp),
          )));
      }
      updateHandlers(t) {
        this.handlers = t;
    ...
    function nW({ point: t }, e) {
      return {
        ...
        velocity: (function (t, e) {
          ...
          for (
            ;
            i >= 0 && ((n = t[i]), !(s.timestamp - n.timestamp > ii(0.1)));
    ...
    class nG {
        ...
        (t && e0(t)
          ...
          : t && i
            ? (this.constraints = (function (
                ...
                return { x: nY(t.x, i, s), y: nY(t.y, e, n) };
              })(i.layoutBox, t))
            : (this.constraints = !1),
      ...
      resolveRefConstraints() {
        ...
        let r = (function (t, e, i) {
          ...
          o = ((t = s.layout.layoutBox), { x: nX(t.x, r.x), y: nX(t.y, r.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
      ...
      scalePositionWithinConstraints() {
        ...
        if (!e0(e) || !i || !this.constraints) return;
        this.stopAnimation();
        let n = { x: 0, y: 0 };
        nB((t) => {
          ...
          if (e && !1 !== this.constraints) {
            ...
            n[t] =
              ...
              (o = nk(i)),
              (a = nk(s)) > o
                ? (r = i_(s.min, s.max - o, i.min))
                : o > a && (r = i_(i.min, i.max - a, s.min)),
              U(0, 1, r));
          }
        });
    ...
    class n5 extends nJ.Component {
      componentDidMount() {
        let {
          ...
          { projection: s } = t;
        for (let t in n9) ((eP[t] = n9[t]), w(t) && (eP[t].isCSSVariable = !0));
        (s &&
    ...
    function n3(t) {
      let [e, i] = (function (t = !0) {
        ...
        n = (0, nJ.useContext)(eO);
      return (0, r.jsx)(n5, {
        ...t,
        layoutGroup: n,
        switchLayoutGroup: (0, nJ.useContext)(e2),
        isPresent: e,
        safeToRemove: i,
      });
    }
    ...
    function n6(t) {
      return n4(t) && "ownerSVGElement" in t;
    }
    let n8 = (t, e) => t.depth - e.depth;
    class n7 {
      constructor() {
      ...
      forEach(t) {
        (this.isDirty && this.children.sort(n8),
          (this.isDirty = !1),
          this.children.forEach(t));
      }
    }
    let st = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
      se = st.length,
      si = (t) => ("string" == typeof t ? parseFloat(t) : t),
      sn = (t) => "number" == typeof t || H.test(t);
    function ss(t, e) {
    ...
    let sr = sa(0, 0.5, iX),
      so = sa(0.5, 0.95, to);
    function sa(t, e, i) {
      return (n) => (n < t ? 0 : n > e ? 1 : i(i_(t, e, n)));
    }
    function sl(t, e) {
    ...
    function sc(t, e, [i, n, s], r, o) {
      !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
        if (
          ...
          return;
        let a = M(r.min, r.max, n);
        (t === r && (a -= e),
          (t.min = sd(t.min, e, i, a, s)),
          (t.max = sd(t.max, e, i, a, s)));
      })(t, e[i], e[n], e[s], e.scale, r, o);
    }
    let sp = ["x", "scaleX", "originX"],
      sm = ["y", "scaleY", "originY"];
    function sf(t, e, i, n) {
      (sc(t.x, e, sp, i ? i.x : void 0, n ? n.x : void 0),
        sc(t.y, e, sm, i ? i.y : void 0, n ? n.y : void 0));
    }
    function sg(t) {
    ...
    function sE({
      ...
      return class {
        constructor(t = {}, i = e?.()) {
          ...
          this.root === this && (this.nodes = new n7());
        }
        ...
        mount(e) {
          ...
          ((this.isSVG = n6(e) && !(n6(e) && "svg" === e.tagName)),
            (this.instance = e));
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let r =
                      this.options.transition || s.getDefaultTransition() || sY,
                    {
                  ...
                  if (
                    ...
                    let e = { ...e4(r, "layout"), onPlay: o, onComplete: a };
        ...
        update() {
          ...
          if (this.animationId <= this.animationCommitId)
            return void this.nodes.forEach(sj);
        ...
        clearAllSnapshots() {
          (this.nodes.forEach(sR), this.sharedNodes.forEach(sN));
        }
        ...
        removeElementScroll(t) {
          let e = ei();
          if ((sh(e, t), this.scroll?.wasRoot)) return e;
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sh(e, t), j(e.x, s.offset.x), j(e.y, s.offset.y));
          }
          return e;
        }
        applyTransform(t, e = !1) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            (!e &&
              ...
              C(n.latestValues) && B(i, n.latestValues));
          }
        ...
        removeTransform(t) {
          ...
          return (C(this.latestValues) && sf(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o ||
                  ...
                  (n &&
                    ...
                    s.scroll &&
                    s !== s.root &&
                    B(t, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), L(t, r)),
                  n && C(s.latestValues) && B(t, s.latestValues));
              }
              ...
              if (
                ...
                (nF(
                  ...
                  i &&
                    ...
                    (c = i),
                    sv(h.x, c.x) && sv(h.y, c.y)) &&
                    (this.isProjectionDirty = !1),
                  i || (i = ei()),
                  sh(i, this.relativeTarget));
              }
              (l &&
                ((this.animationValues = r),
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = M(0, i.opacity ?? 1, sr(n))),
                      (t.opacityExit = M(e.opacity ?? 1, 0, so(n))))
                    : r && (t.opacity = M(e.opacity ?? 1, i.opacity ?? 1, n));
                  for (let s = 0; s < se; s++) {
                    let r = `border${st[s]}Radius`,
                      o = ss(e, r),
                      a = ss(i, r);
                    (void 0 !== o || void 0 !== a) &&
                      (o || (o = 0),
                      a || (a = 0),
                      0 === o || 0 === a || sn(o) === sn(a)
                        ? ((t[r] = Math.max(M(si(o), si(a), n), 0)),
                          (X.test(a) || X.test(o)) && (t[r] += "%"))
                        : (t[r] = a));
                  }
                  (e.rotate || i.rotate) &&
                    (t.rotate = M(e.rotate || 0, i.rotate || 0, n));
        ...
        registerSharedNode(t, e) {
          (this.sharedNodes.has(t) || this.sharedNodes.set(t, new sP()),
        ...
        resetSkewAndRotation() {
          ...
          for (let e = 0; e < sS.length; e++)
            (sM(`rotate${sS[e]}`, t, n, this.animationValues),
              sM(`skew${sS[e]}`, t, n, this.animationValues));
    ...
    function sC(t) {
      ...
      if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
        ...
        let a = et();
        r
          ? nR(a, t.applyTransform(n, !0), e.measuredBox)
          : nR(a, i, e.layoutBox);
        let l = !sy(o),
          h = !1;
        if (!t.resumeFrom) {
    ...
    function sW(t, e, i, n) {
      ((t.min = M(e.min, i.min, n)), (t.max = M(e.max, i.max, n)));
    }
    function sz(t) {
      return t.animationValues && void 0 !== t.animationValues.opacityExit;
    }
    let sY = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      sX = (t) =>
        "undefined" != typeof navigator &&
        navigator.userAgent &&
        navigator.userAgent.toLowerCase().includes(t),
      sH = sX("applewebkit/") && !sX("chrome/") ? Math.round : to;
    function sK(t) {
      ((t.min = sH(t.min)), (t.max = sH(t.max)));
    }
    function sq(t, e, i) {
      return (
        "position" === t ||
    ...
    function s1(t, e, i) {
      ...
      let s = n["onHover" + i];
      s && tu.postRender(() => s(e, nV(e)));
    }
    let s2 = (t, e) => !!e && (t === e || s2(t, e.parentElement)),
      s5 = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
      s3 = new WeakSet();
    function s9(t) {
      return (e) => {
        "Enter" === e.key && t(e);
      ...
      rs = (function (t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            "create" === r
              ? n
              : (i.has(r) || i.set(r, e3(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          animation: {
                          ...
                          Promise.all(
                            e.map(({ animation: e, options: i }) =>
                              (function (t, e, i = {}) {
                                ...
                                else if ("string" == typeof e) n = ng(t, e, i);
                                else {
                                  let s =
                                    "function" == typeof e
                                      ? e9(t, e, i.custom)
              ...
              startObserver() {
                ...
                let { viewport: i = {} } = this.node.getProps(),
                  ...
                  a = {
                    ...
                    rootMargin: s,
                    threshold: "number" == typeof r ? r : rn[r],
                  },
                  l = (t) => {
                ...
                return (
                  ...
                  (e = (function ({ root: t, ...e }) {
                    ...
                    return (
                      n[s] ||
                        (n[s] = new IntersectionObserver(ri, {
                          root: t,
                          ...e,
                        })),
                      n[s]
              ...
              mount() {
                ...
                t &&
                  (this.unmount = (function (t, e, i = {}) {
                    ...
                    t,
                    (t, e) => (
                      s8(this.node, e, "Start"),
                      (t, { success: e }) =>
                        s8(this.node, t, e ? "End" : "Cancel")
                    ),
              ...
              mount() {
                ...
                t &&
                  (this.unmount = (function (t, e, i = {}) {
                    ...
                    t,
                    (t, e) => (
                      s1(this.node, e, "Start"),
                      (t) => s1(this.node, t, "End")
                    ),
                  ));
              }
              unmount() {}
          ...
          pan: {
            Feature: class extends nP {
              ...
              mount() {
                this.removePointerDownListener = nC(
                  this.node.current,
                  "pointerdown",
          ...
          layout: { ProjectionNode: sJ, MeasureLayout: n3 },
        },
        (t, e) =>
    ...
    t.s(
      [
        "default",
        0,
        ({ handleClick: t, uuid: e }) => {
          let [i, n] = (0, a.useState)(null),
            [s, l] = (0, a.useState)(!1),
            ...
            g = (0, a.useCallback)(() => {
              ...
              let t = d.current.getBoundingClientRect(),
                ...
                s = e.height;
              n({
                x: Math.random() * (i - t.width - 20) + 10,
                y: Math.random() * (s - t.height - 20) + 10,
              });
            }, []),
            y = (0, a.useCallback)(
              (t) => {
                ...
                100 >
                Math.sqrt(
                  Math.pow(i - (e.left + e.width / 2), 2) +
                    Math.pow(n - (e.top + e.height / 2), 2),
                )
                  ? (l(!0), g())
                  : l(!1);
              },
          ...
          return (
              ...
              let t = () => {
                if (c.current && p.current) {
                  let t = c.current.getBoundingClientRect(),
                    e = p.current.getBoundingClientRect(),
                    i = t.width / 2 - 50,
                    s = e.bottom + 30;
                  (u({ x: i, y: s }), n({ x: i, y: s }), f(!0));
                }
              };
              return (
                setTimeout(t, 0),
            ...
            (0, r.jsxs)("div", {
              className:
                "h-dvh flex flex-col items-center justify-center relative overflow-hidden",
              ref: c,
              onMouseMove: y,
              children: [
                (0, r.jsx)("div", {
                ...
                (0, r.jsx)("div", {
                  ...
                  children: (0, r.jsx)(o.default, {
                    options: {
                      strings: "Just go to the next level",
                      cursor: "_",
                      delay: 20,
                      autoStart: !0,
                    },
                ...
                m &&
                  ...
                  (0, r.jsx)(rs.button, {
                    ref: d,
                    className: "border mt-8 px-4 py-1 z-10 absolute",
                    style: { left: h.x, top: h.y },
                    animate: { x: i ? i.x - h.x : 0, y: i ? i.y - h.y : 0 },
                    transition: {
                      type: "spring",
                      stiffness: 200,
                      damping: 15,
                ...
                !m &&
                  (0, r.jsx)("button", {
                    ref: d,
                    className: "border mt-8 px-4 py-1 z-10 absolute",
                    style: { left: -1e3, top: -1e3, opacity: 0 },
                    children: "Click Me",
                  }),
              ],
            })
